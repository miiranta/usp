...
_colors = sns.color_palette('husl', 200)
_source_order = [
    'Control',
    'Shannon',
    'Cross Entropy',
    ...
    'Effective Dimensionality Entropy',
    'Latent Entropy',
    'Structural Entropy',
    'Topological Entropy',
    ...
    'Softmax Temperature Entropy',
    'Renyi Divergence',
    'Wasserstein Entropy',
    'Flow Entropy',
    'Spike Entropy',
    'Population Coding Entropy',
    'Hessian Trace',
    'Hessian Spectral Radius',
    'Fisher Info Condition Number',
    'Sharpness Perturbation',
    'PAC Bayes Flatness',
    'Gradient Covariance Trace',
    'Gradient Direction Entropy',
    'Gradient Cosine Drift',
    'Activation Jacobian Frobenius Norm',
    'Layerwise Lipschitz',
    'Effective Rank Activations',
    'Log Det Activation Covariance',
    ...
    'PAC Bayes KL',
    'Activation Total Correlation',
    'Entropy Rate Activations',
    'Lyapunov Exponent',
    'Topological Persistence Entropy',
    'VC Dimension Proxy',
    'Spectral Decay Rate',
    'Distributional Flatness',
    'Hessian Log Determinant',
    'Hessian Eigenvalue Entropy',
    'Gradient Subspace Dimension',
    'Jacobian Mutual Coherence',
    'Activation Covariance Condition',
    'Spectral Participation Ratio',
    'Energy Landscape Ruggedness',
    'Gradient Sign Entropy',
    'Activation Skewness',
    'Singular Vector Alignment Entropy',
    'Spectral Gap Activation',
    'Lipschitz Variance',
    'Third Order Curvature Norm',
    'Curvature Skewness',
    'Curvature Kurtosis',
    'Loss Surface Convexity Ratio',
    'Curvature Gradient Alignment',
    'Local Loss Lipschitz Constant',
    'Activation Description Length',
    'Kolmogorov Structure Index',
    'Empirical Covering Number',
    'Cross Layer Rank Coupling',
    'Capacity Utilization Ratio',
    'VC Margin Ratio',
    'Higher Order Cumulant Energy',
    'Logit Gap Entropy',
    'Output Bimodality Coefficient',
    'Population Sparsity Gini',
    'Activation Kurtosis Variance',
    'Lyapunov Spectrum Width',
    'Update Direction Autocorrelation',
    'Stochastic Stability Radius',
    'Functional Inertia',
...
SOURCES = [
    ...
    # ('Neural Representation Entropy', os.path.join(BASE_OUTPUT_DIR, '12_neural_representation_entropy')),
    # ('Diffusion Spectral Entropy', os.path.join(BASE_OUTPUT_DIR, '13_diffusion_spectral_entropy')),
    ...
    ('Sharpness Perturbation', os.path.join(BASE_OUTPUT_DIR, '58_sharpness_perturbation')),
    # ('PAC Bayes Flatness', os.path.join(BASE_OUTPUT_DIR, '59_pac_bayes_flatness')),
    # ('Gradient Covariance Trace', os.path.join(BASE_OUTPUT_DIR, '60_gradient_covariance_trace')),
    # ('Gradient Direction Entropy', os.path.join(BASE_OUTPUT_DIR, '61_gradient_direction_entropy')),
    ('Gradient Cosine Drift', os.path.join(BASE_OUTPUT_DIR, '62_gradient_cosine_drift')),
    # ('Activation Jacobian Frobenius Norm', os.path.join(BASE_OUTPUT_DIR, '63_activation_jacobian_frobenius_norm')),
    # ('Layerwise Lipschitz', os.path.join(BASE_OUTPUT_DIR, '64_layerwise_lipschitz')),
    # ('Effective Rank Activations', os.path.join(BASE_OUTPUT_DIR, '65_effective_rank_activations')),
    # ('Log Det Activation Covariance', os.path.join(BASE_OUTPUT_DIR, '66_log_det_activation_covariance')),
    # ('Information Compression Ratio', os.path.join(BASE_OUTPUT_DIR, '68_information_compression_ratio')),
    # ('Trajectory Length', os.path.join(BASE_OUTPUT_DIR, '69_trajectory_length')),
    # ('MDL Surrogate', os.path.join(BASE_OUTPUT_DIR, '73_mdl_surrogate')),
    # ('Kolmogorov Complexity Proxy', os.path.join(BASE_OUTPUT_DIR, '74_kolmogorov_complexity_proxy')),
    # ('Fractal Dimension', os.path.join(BASE_OUTPUT_DIR, '75_fractal_dimension')),
    # ('NTK Condition Number', os.path.join(BASE_OUTPUT_DIR, '76_ntk_condition_number')),
    # ('NTK Trace', os.path.join(BASE_OUTPUT_DIR, '77_ntk_trace')),
    ('Rademacher Complexity', os.path.join(BASE_OUTPUT_DIR, '78_rademacher_complexity')),
    # ('PAC Bayes KL', os.path.join(BASE_OUTPUT_DIR, '79_pac_bayes_kl')),
    # ('Activation Total Correlation', os.path.join(BASE_OUTPUT_DIR, '80_activation_total_correlation')),
    # ('Entropy Rate Activations', os.path.join(BASE_OUTPUT_DIR, '84_entropy_rate_activations')),
    # ('Lyapunov Exponent', os.path.join(BASE_OUTPUT_DIR, '85_lyapunov_exponent')),
    # ('Topological Persistence Entropy', os.path.join(BASE_OUTPUT_DIR, '86_topological_persistence_entropy')),
    # ('VC Dimension Proxy', os.path.join(BASE_OUTPUT_DIR, '88_vc_dimension_proxy')),
    # ('Spectral Decay Rate', os.path.join(BASE_OUTPUT_DIR, '89_spectral_decay_rate')),
    # ('Distributional Flatness', os.path.join(BASE_OUTPUT_DIR, '90_distributional_flatness')),
    # ('Hessian Log Determinant', os.path.join(BASE_OUTPUT_DIR, '91_hessian_log_determinant')),
    # ('Hessian Eigenvalue Entropy', os.path.join(BASE_OUTPUT_DIR, '92_hessian_eigenvalue_entropy')),
    # ('Gradient Subspace Dimension', os.path.join(BASE_OUTPUT_DIR, '93_gradient_subspace_dimension')),
    # ('Jacobian Mutual Coherence', os.path.join(BASE_OUTPUT_DIR, '94_jacobian_mutual_coherence')),
    # ('Activation Covariance Condition', os.path.join(BASE_OUTPUT_DIR, '95_activation_covariance_condition')),
    # ('Spectral Participation Ratio', os.path.join(BASE_OUTPUT_DIR, '96_spectral_participation_ratio')),
    # ('Energy Landscape Ruggedness', os.path.join(BASE_OUTPUT_DIR, '97_energy_landscape_ruggedness')),
    # ('Gradient Sign Entropy', os.path.join(BASE_OUTPUT_DIR, '98_gradient_sign_entropy')),
    # ('Activation Skewness', os.path.join(BASE_OUTPUT_DIR, '99_activation_skewness')),
    # ('Singular Vector Alignment Entropy', os.path.join(BASE_OUTPUT_DIR, '100_singular_vector_alignment_entropy')),
    # ('Spectral Gap Activation', os.path.join(BASE_OUTPUT_DIR, '103_spectral_gap_activation')),
    ('Lipschitz Variance', os.path.join(BASE_OUTPUT_DIR, '104_lipschitz_variance')),
    ('Third Order Curvature Norm', os.path.join(BASE_OUTPUT_DIR, '105_third_order_curvature_norm')),
    # ('Curvature Skewness', os.path.join(BASE_OUTPUT_DIR, '106_curvature_skewness')),
    # ('Curvature Kurtosis', os.path.join(BASE_OUTPUT_DIR, '107_curvature_kurtosis')),
    # ('Loss Surface Convexity Ratio', os.path.join(BASE_OUTPUT_DIR, '108_loss_surface_convexity_ratio')),
    # ('Curvature Gradient Alignment', os.path.join(BASE_OUTPUT_DIR, '112_curvature_gradient_alignment')),
    # ('Local Loss Lipschitz Constant', os.path.join(BASE_OUTPUT_DIR, '114_local_loss_lipschitz_constant')),
    # ('Activation Description Length', os.path.join(BASE_OUTPUT_DIR, '115_activation_description_length')),
    # ('Kolmogorov Structure Index', os.path.join(BASE_OUTPUT_DIR, '116_kolmogorov_structure_index')),
    ('Empirical Covering Number', os.path.join(BASE_OUTPUT_DIR, '117_empirical_covering_number')),
    # ('Cross Layer Rank Coupling', os.path.join(BASE_OUTPUT_DIR, '118_cross_layer_rank_coupling')),
    # ('Capacity Utilization Ratio', os.path.join(BASE_OUTPUT_DIR, '120_capacity_utilization_ratio')),
    # ('VC Margin Ratio', os.path.join(BASE_OUTPUT_DIR, '121_vc_margin_ratio')),
    # ('Higher Order Cumulant Energy', os.path.join(BASE_OUTPUT_DIR, '122_higher_order_cumulant_energy')),
    # ('Logit Gap Entropy', os.path.join(BASE_OUTPUT_DIR, '123_logit_gap_entropy')),
    # ('Output Bimodality Coefficient', os.path.join(BASE_OUTPUT_DIR, '124_output_bimodality_coefficient')),
    # ('Population Sparsity Gini', os.path.join(BASE_OUTPUT_DIR, '125_population_sparsity_gini')),
    ('Activation Kurtosis Variance', os.path.join(BASE_OUTPUT_DIR, '126_activation_kurtosis_variance')),
    # ('Lyapunov Spectrum Width', os.path.join(BASE_OUTPUT_DIR, '127_lyapunov_spectrum_width')),
    ('Update Direction Autocorrelation', os.path.join(BASE_OUTPUT_DIR, '128_update_direction_autocorrelation')),
    # ('Stochastic Stability Radius', os.path.join(BASE_OUTPUT_DIR, '130_stochastic_stability_radius')),
    # ('Functional Inertia', os.path.join(BASE_OUTPUT_DIR, '131_functional_inertia')),
    # ('Implicit Bias Alignment', os.path.join(BASE_OUTPUT_DIR, '132_implicit_bias_alignment')),
]
