...
SOURCES = [
    ...
    ('Disequilibrium', os.path.join(BASE_OUTPUT_DIR, '0_disequilibrium')),
    # ('Symmetry Breaking', os.path.join(BASE_OUTPUT_DIR, '1_symmetry_breaking')),
    # ('Excess Entropy', os.path.join(BASE_OUTPUT_DIR, '2_excess_entropy')),
    # ('Energy Distance', os.path.join(BASE_OUTPUT_DIR, '3_energy_distance')),
    # ('Flatness Avoidance', os.path.join(BASE_OUTPUT_DIR, '4_flatness_avoidance')),
    # ('Multimodality', os.path.join(BASE_OUTPUT_DIR, '5_multimodality')),
    # ('Broken Ergodicity', os.path.join(BASE_OUTPUT_DIR, '6_broken_ergodicity')),
    # ('Participation Ratio', os.path.join(BASE_OUTPUT_DIR, '7_participation_ratio')),
    # ('Wasserstein Uniform', os.path.join(BASE_OUTPUT_DIR, '10_wasserstein_uniform')),
    # ('Theil Index', os.path.join(BASE_OUTPUT_DIR, '12_theil_index')),
    ('Inverse Spectral Flatness', os.path.join(BASE_OUTPUT_DIR, '13_inverse_spectral_flatness')),
    # ('Logit Variance', os.path.join(BASE_OUTPUT_DIR, '22_logit_variance')),
    ('Margin Entropy', os.path.join(BASE_OUTPUT_DIR, '23_margin_entropy')),
    # ('Feature Rank', os.path.join(BASE_OUTPUT_DIR, '25_feature_rank')),
    # ('Fractal Dim', os.path.join(BASE_OUTPUT_DIR, '26_fractal_dim')),
    ('PAC Bayes', os.path.join(BASE_OUTPUT_DIR, '27_pac_bayes')),
    # ('Path Norm', os.path.join(BASE_OUTPUT_DIR, '28_path_norm')),
    ('Hessian Spectral Radius', os.path.join(BASE_OUTPUT_DIR, '30_hessian_spectral_radius')),
    ('Fisher Info Condition Number', os.path.join(BASE_OUTPUT_DIR, '31_fisher_info_condition_number')),
    ('Sharpness Perturbation', os.path.join(BASE_OUTPUT_DIR, '32_sharpness_perturbation')),
    ('Gradient Covariance Trace', os.path.join(BASE_OUTPUT_DIR, '34_gradient_covariance_trace')),
    ('Gradient Direction Entropy', os.path.join(BASE_OUTPUT_DIR, '35_gradient_direction_entropy')),
    ('Gradient Cosine Drift', os.path.join(BASE_OUTPUT_DIR, '36_gradient_cosine_drift')),
    # ('Activation Jacobian Frobenius Norm', os.path.join(BASE_OUTPUT_DIR, '37_activation_jacobian_frobenius_norm')),
    # ('Effective Rank Activations', os.path.join(BASE_OUTPUT_DIR, '39_effective_rank_activations')),
    # ('Log Det Activation Covariance', os.path.join(BASE_OUTPUT_DIR, '40_log_det_activation_covariance')),
    ('Trajectory Length', os.path.join(BASE_OUTPUT_DIR, '43_trajectory_length')),
    # ('Stochastic Loss Variance', os.path.join(BASE_OUTPUT_DIR, '44_stochastic_loss_variance')),
    ('Local Linearization Error', os.path.join(BASE_OUTPUT_DIR, '45_local_linearization_error')),
    # ('MDL Surrogate', os.path.join(BASE_OUTPUT_DIR, '47_mdl_surrogate')),
    # ('Kolmogorov Complexity Proxy', os.path.join(BASE_OUTPUT_DIR, '48_kolmogorov_complexity_proxy')),
]
