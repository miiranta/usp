...
BASE_OUTPUT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'output_max')
PLOTS_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'plots_max')

# Limits for plotting
# Set to 0 to disable limiting
TOP_X_LOWEST_VAL_LOSS = 15
