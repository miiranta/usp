...
SOURCE_PALETTE = {
    'Control': _colors[0],
    'Shannon': _colors[1],
    'Cross Entropy': _colors[2],
    'Conditional Entropy': _colors[3],
    'Joint Entropy': _colors[4],
    'Mutual Information': _colors[5],
    'Conditional MI': _colors[6],
    'KL Divergence': _colors[7],
