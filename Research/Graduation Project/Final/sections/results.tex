...
\subsection{Complexity vs Benchmarks}
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.72\linewidth]{img/comp_lmarena_regression.png}
        \caption{Regression lines for LMC complexity vs LMArena benchmark.}
    \end{figure}

    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.72\linewidth]{img/comp_mmlu_regression.png}
        \caption{Regression lines for LMC complexity vs MMLU benchmark.}
    \end{figure}

    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.72\linewidth]{img/comp_mmlupro_regression.png}
        \caption{Regression lines for LMC complexity vs MMLU-Pro benchmark.}
    \end{figure}

    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.72\linewidth]{img/comp_openllm_regression.png}
