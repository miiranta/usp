...
\label{sec:complexity_vs_benchmark_performance_results}
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.7\linewidth]{img/noembed-weights/control_correlation_comparison.png}
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.7\linewidth]{img/noembed-weights/complexity_correlation_comparison.png}
