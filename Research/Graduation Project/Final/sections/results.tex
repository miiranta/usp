...
\subsection{Complexity vs Benchmarks}
    ...
    Following the methodology described in section \ref{sec:complexity_vs_benchmark_performance}, first, we made a control plot using a known correlation: parameter count vs benchmark performance. The results are as follows:

    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.8\linewidth]{img/control_correlation_comparison.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{img/control_r2_linear_comparison.png}
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.8\linewidth]{img/complexity_correlation_comparison.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{img/complexity_r2_linear_comparison.png}
        \caption{Linear regression $R^2$ values for complexity vs benchmark performance.}
        \label{fig:complexity_r2_linear_comparison}
    \end{figure}

    It is immidiately clear that results are inconsistent across benchmarks. While \textbf{LMArena} and \textbf{MMLU} show a positive correlation between complexity and performance, \textbf{MMLU-Pro} and \textbf{OpenLLM} show a negative correlation.
    ...
    We also found the the statistical significance of the correlations found using  t-tests \cite{Fisher1921}:
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|c|c|c|c|c|c|}
            ...
            \hline
            LMArena & 0.2535 & 300 & 4.52 & 0.000006 & Yes \\
            \hline
            MMLU & 0.1741 & 374 & 3.40 & 0.000674 & Yes \\
            \hline
            MMLU-Pro & -0.1704 & 214 & -2.51 & 0.012073 & Yes \\
            \hline
            OpenLLM & -0.0806 & 341 & -1.48 & 0.138873 & No \\
            \hline
            all & 0.0238 & 1229 & 0.83 & 0.406539 & No \\
            \hline
        \end{tabular}
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.7\linewidth]{img/comp_lmarena_regression.png}
        \caption{Regression lines for LMC complexity vs LMArena benchmark.}
    \end{figure}

    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.7\linewidth]{img/comp_mmlu_regression.png}
        \caption{Regression lines for LMC complexity vs MMLU benchmark.}
    \end{figure}

    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.7\linewidth]{img/comp_mmlupro_regression.png}
        \caption{Regression lines for LMC complexity vs MMLU-Pro benchmark.}
    \end{figure}

    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.7\linewidth]{img/comp_openllm_regression.png}
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.8\linewidth]{img/top_20_correlations.png}
