...
Talk about similarities between benchmarks....

Problems collecting benchmark data...

Maybe the correlation is true but different models or model families are not comparable..., you need to compare within families only...
