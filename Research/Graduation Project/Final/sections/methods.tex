...
\subsection{Comparing LMC Complexity and Inference Capability}
    ...
    \label{sec:complexity_vs_benchmark_performance}
        ...
        where $x$ is the original benchmark score for a model, $x_{\min}$ is the minimum score among all models for that specific benchmark, and $x_{\max}$ is the maximum score among all models for that benchmark.
