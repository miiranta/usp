...
% Info
\title{Comparing the LMC Complexity of Neural Networks with their Inference Capability}
...
\preambulo{Dissertation presented to the Faculty of Philosophy, Sciences and Letters of Ribeirão Preto (FFCLRP) from the University of São Paulo (USP), as part of the requirements to hold the Bachelor of Science degree.}
